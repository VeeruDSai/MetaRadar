...
export function AthenaWorkspace() {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Athena Intelligence Synthesis</h1>
      ...
      {/* Query Input Card */}
      <form onSubmit={handleQuery} className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5 space-y-4 shadow-sm">
        <div className="space-y-2">
          <label htmlFor="athena-query" className="block text-xs font-semibold uppercase tracking-wider text-slate-600 dark:text-slate-400">
          ...
          <textarea
            ...
            rows={3}
            className="w-full rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 p-3 text-sm text-slate-900 dark:text-slate-200 focus:outline-none focus:border-blue-500 font-sans"
          />
        </div>
      ...
      {/* Response Card */}
      {response && (
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/70 p-6 space-y-6 shadow-md">
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm text-slate-800 dark:text-slate-200 leading-relaxed whitespace-pre-line bg-slate-50 dark:bg-slate-950/60 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
              {response.answer}
            </div>
          </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="space-y-2">
                {response.evidence.map((cit, idx) => (
                  <div
                    key={idx}
                    className="p-3.5 rounded-lg bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 text-xs space-y-1.5"
                  >
                    ...
                    <p className="text-slate-700 dark:text-slate-300 leading-relaxed font-sans">{cit.excerpt}</p>

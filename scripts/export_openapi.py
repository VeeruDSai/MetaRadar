...
def export_contracts():
    """Exports OpenAPI JSON and generates TypeScript API contracts in frontend/src/types/api.ts."""
    ...
    # 2. Export frontend/src/types/api.ts
    frontend_types_dir = base_dir / "frontend" / "src" / "types"
...
"""
    ...
    ts_path = frontend_types_dir / "api.ts"
    with open(ts_path, "w", encoding="utf-8") as f:
        f.write(ts_content)
    print(f"Exported TypeScript API types to: {ts_path}")
